...
@Component({
  selector: 'app-add-moderateur',
  templateUrl: './add-moderateur.component.html',
  styleUrls: ['./add-moderateur.component.css']
})
export class AddModerateurComponent implements OnInit, OnDestroy {
	...
	handleSignup(): void {
		if (this.signupFormGroup.valid) {
			...
			this.subscriptions.push(
				this.userService.createModerateur(userSignup).subscribe({
