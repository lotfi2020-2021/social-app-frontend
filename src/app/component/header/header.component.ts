	...
	ngOnInit(): void {
		...
		if (this.authService.isUserLoggedIn()) {
			...
			if(this.authUser.role=='superadmin'){
				this.showSuperAdminBoard = this.authUser.role.includes('superadmin');

			}else{
				this.showAdminBoard = this.authUser.role.includes('admin');

			}
			
		
			
			this.showModeratorBoard = this.authUser.role.includes('moderateur');
		} else {
