...
export class SettingsComponent implements OnInit, OnDestroy {
	...
	get updateTelephone() { return this.updateInfoFormGroup.get('telephone') }
	...
	ngOnInit(): void {
		if (!this.authService.isUserLoggedIn()) {
			...
			this.updateInfoFormGroup = this.formBuilder.group({
				...
				telephone: new FormControl(this.authUser.workplace, [Validators.maxLength(8),Validators.minLength(8)]),
	...
	handleUpdateInfo(): void {
		...
		updateUserInfo.telephone = this.updateTelephone.value;
